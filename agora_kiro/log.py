"""
log.py — Centralised logging for agora-kiro.

Silent by default. Enable with:
    AGORA_LOG_LEVEL=DEBUG    agora-kiro serve
    AGORA_LOG_LEVEL=WARNING  agora-kiro serve
    AGORA_LOG_LEVEL=INFO     agora-kiro serve
...
log: logging.Logger = logging.getLogger("agora_kiro")
...
class _SQLiteLogHandler(Handler):
    """Writes WARNING+ log records to the agora-kiro memory.db logs table."""
    ...
    def _init_db(self) -> None:
        import sqlite3
        from agora_kiro.vector_store import DEFAULT_DB
