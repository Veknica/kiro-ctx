"""
indexer.py — Symbol-level code indexing for agora-kiro.
...
def index_file(
    ...
    *,
    ...
    from agora_kiro.summarizer import summarize_file
...
def _extract_python_ast(content: str, file_path: str) -> list[dict]:
    ...
    import ast
    from agora_kiro.summarizer import _func_signature, _ast_name
...
def _extract_with_treesitter(content: str, file_path: str, lang: str) -> list[dict]:
    ...
    from agora_kiro.summarizer import _TS_QUERIES, _preceding_comment
